...
and MMAT_Company_Code =33
and HPO_BA_CODE= j.vendor_code

and HPO_Company_Code=33
and HPO_Job_Code= p.job_code 
and j.company_code = 'LJ'
and p.company_code='LJ'
...
and hpo_po_number in ('JJ001PO7000003',
'JJ001PO7000005',
'JJ001PO7000006',
'JJ001PO8000001',
'JJ001PO8000002',
...
where Dpo_Material_Code=LMMCLM_Material_Code and LMMCLM_Company_Code=33 
...
where  materialcategory= f.MMC_Material_Category_Code and f.MMC_Company_Code=33 
