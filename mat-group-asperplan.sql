...
--and hmrn_mrn_date between '01-Jan-2017' and '30-June-2017'
...
select MMAT_Material_Code, MMATC_Description, mmgrp_mg_code,mmgrp_description, MMAT_Material_Description, LMMCLM_Material_Category_Code, MMC_Description,MMAT_ISActive into #grouplink
...
epm.sqlpmp.GEN_M_Material_Category
where c.MMGRP_MG_Code= MMAT_MG_Code  and MMATC_Class_Code = c.MMGRP_Class_Code
