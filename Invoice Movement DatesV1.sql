...
and tlreg_lr_date between '01-June-2016' and '31-dec-2017' and a.TLREG_Dt_Code in ( 403,404)
...
where TLRBR_Cheque_Date between '01-Jan-2017' and '21-Aug-2018'
...
select mrdate, MrAuthDate, POAuth, GinDate,	mrndate,MRNAuthDate,Invregisterdate,MinScrutinyDate,	MaxScrutinyDate,	JVDate,	MinDisbdate,	Maxdisbdate,	HPO_PO_Number,	BUdesc,	ICdesc,	TLREG_LR_Number, invvalue,HPO_JOB_NUMBER,JOB_DESCRIPTION	
from #invoices a, eip.sqlscm.SCM_H_Purchase_Orders, LNT.DBO.JOB_MASTER
where a.ordernumber = HPO_PO_Number AND HPO_JOB_NUMBER = JOB_NUMBER 
...
JVDate,MinDisbdate,Maxdisbdate,BUdesc,ICdesc,DLRV_LR_Number,DLRV_WO_Bill_Number,	HWO_Job_Code,job_description,	HWO_WOT_Code, invvalue, ordernumber
from #invoices a, eip.sqlfas.FAS_D_Ledger_Register_Vendor b, eip.sqlwom.WOM_H_Bills c,eip.sqlwom.WOM_H_Work_Orders d, lnt.dbo.job_master 
		--,eip.sqlwom.WOM_M_Job_Item_Codes
where a.tlreg_lr_number = b.DLRV_LR_Number and a.ordernumber = HWO_WO_Number
and b.DLRV_WO_Bill_Number= hbill_bill_number --and DWMBL_Item_Code= MJITC_Item_Code 
and hwo_job_code = job_code
